...
class ViewController: UIViewController {
    ...
    override func loadView() {
        ...
        //touchUpInside -> the user pressed down on the button and lifted their touch while it was still inside.
    ...
    @objc func submitTapped(_ sender: UIButton) {
        ...
        if let solutionPosition = solitions.firstIndex(of: answerText) {
    ...
    func levelUp(action: UIAlertAction) {
        ...
        solitions.removeAll(keepingCapacity: true)
        loadLevel()
